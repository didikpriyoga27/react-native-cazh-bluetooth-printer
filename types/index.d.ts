declare module "react-native-cazh-bluetooth-printer" {
  ...
  export type PrintLabelOptions = {
    ...
    reference?: any[];
    sound?: number | READABLE;
    home?: number | READABLE;
  };
  ...
  export class BluetoothEscposPrinter {
    static ERROR_CORRECTION = {
      L = 1,
      M = 0,
      Q = 3,
      H = 2,
    };
    static ESC_BARCODETYPE = {
      UPC_A = 65, //11<=n<=12
      UPC_E = 66, //11<=n<=12
      JAN13 = 67, //12<=n<=12
      JAN8 = 68, //7<=n<=8
    ...
    static printColumn(
      columnWidths: number[],
      columnAligns: number[] | ALIGN[],
      columnTexts: string[],
      options?: PrintTextOptions
    ): void | string | PromiseLike<void> | PromiseLike<string>;
    static setWidth(width: number | PAGE_WIDTH): void | PromiseLike<void>;
    static printPic(
      base64Image: string,
    ...
    static rotate(
      rotate: number | ESC_ROTATION
    ): void | string | PromiseLike<void> | PromiseLike<string>;
    static setBold(
      weight: number | ESC_ROTATION
    ): void | string | PromiseLike<void> | PromiseLike<string>;
    static printQRCode(
      content: string,
      size: number,
      correctionLevel: number | ERROR_CORRECTION,
      leftPadding?: number
    ): void | string | PromiseLike<void> | PromiseLike<string>;
    static printBarCode(
      content: string,
      barcodeType: number | ESC_BARCODETYPE,
      width: number,
      height: number,
